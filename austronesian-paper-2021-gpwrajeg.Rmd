...
```{r mpi-corpus-relationship, fig.cap = "Schematic relationship between files in the MPI EVA JFS corpora (Available from https://lingweb.eva.mpg.de/archive/jakarta/data.php.html)", fig.asp = .9, fig.width=9}
knitr::include_graphics("figures/FIG-mpi-relationship.png", dpi = 300)
```
